...
template <class T>
const util::Binary QR<T>::PAD_BYTES1_ = util::Binary("11101100");

template <class T>
const util::Binary QR<T>::PAD_BYTES2_ = util::Binary("00010001");

template <class T>
const std::map<std::string, std::string> QR<T>::EC_CODEWORDS_ = {
  {"1-L",	"19:7:1:19:0:0"},
  {"1-M",	"16:10:1:16:0:0"},
  {"1-Q",	"13:13:1:13:0:0"},
  {"1-H",	"9:17:1:9:0:0"},
...
template <class T>
const std::map<char, size_t> QR<T>::REMAINDER_BITS_ = {
  {'1',	0},
  {2,	7},
  {3,	7},
  {4,	7},
